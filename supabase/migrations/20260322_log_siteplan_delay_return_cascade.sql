-- Migration: modify log_siteplan_delay to return JSONB containing
-- the new delay log UUID and the array of successor task IDs that were shifted.
--
...
BEGIN
  ...
  --    collecting their IDs for the response.
