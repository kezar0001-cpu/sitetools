                ...
                <div className="flex flex-col items-center gap-4 text-center">
                    ...
                    <div>
                        ...
                        <p className="text-sm font-medium text-slate-500 mt-1">
                            Sign in to the Buildstate platform
                        </p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            required
                            className="w-full border-2 border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-amber-400 focus:ring-4 focus:ring-amber-400/20 transition-all font-medium text-slate-900 placeholder:text-slate-400"
