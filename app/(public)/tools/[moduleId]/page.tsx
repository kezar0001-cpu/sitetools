    ...
    return (
        <div className="bg-slate-50 min-h-full py-16">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
                <Link href="/tools" className="text-sm font-semibold text-slate-600 hover:text-slate-900">← Back to all modules</Link>
                ...
                <section className="bg-white border border-slate-200 rounded-2xl p-8 space-y-6">
                    <div className="flex items-center justify-between gap-4 flex-wrap">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-xs uppercase tracking-widest text-slate-500">Buildstate module</p>
                    ...
                    <div className="rounded-xl bg-slate-50 border border-slate-200 p-5">
                        <h2 className="font-bold text-slate-900 mb-2">How it fits into Buildstate</h2>
                        <p className="text-sm text-slate-600">
                            This module is part of the Buildstate ecosystem, designed to share account, organisation, and project context with other modules while remaining usable on its own.
                        </p>
                    </div>
